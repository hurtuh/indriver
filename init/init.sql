...
USE `interviews`;
CREATE TABLE IF NOT EXISTS `interviews`.`candidate` (`id` int auto_increment, PRIMARY KEY(id), `created` datetime, `name` varchar(200), `lastname` varchar(200), `interview` datetime, `description` varchar(200));
